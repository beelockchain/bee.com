...
const Footer = () => {
 ...
 {/* TITLE */}
        <h2 className="text-[28px] sm:text-[26px] md:text-[32px]  xl:text-[32px] lg:text-[38px] text-center font-semibold text-black font-poppins mb-12">
Area We Occupied
        </h2>
        {/* ================= CARD GRID ================= */}
...
<div className="flex gap-2 md:gap-2 lg:gap-1 xl:gap-4">
  ...
  <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-4 
   text-[12px] sm:text-[14px] md:text-[12px]  xl:text-[16px] lg:text-[16px] text-black/70 font-poppins text-center md:text-left">
    ...
    <p>© 2026 Beelockchain. All Rights Reserved.</p>
