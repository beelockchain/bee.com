...
const DevopsTechnologies = () => {
  ...
  const categories = [
    ...
    { key: "CI/CD & Release Automation" as string, label: "CI/CD & Release Automation" },
    { key: "Containerization" as string, label: "Containerization" },
    { key: "Container Orchestration" as string, label: "Container Orchestration" },
    { key: "Infrastructure Automation" as string, label: "Infrastructure Automation" },
    { key: "Infrastructure as Code (IaC)" as string, label: "Infrastructure as Code (IaC)" },
    { key: "Monitoring & Logging" as string, label: "Monitoring & Logging" },
    { key: "Coding & Scripting" as string, label: "Coding & Scripting" },
    { key: "Testing Automation Tools" as string, label: "Testing Automation Tools" },
    { key: "Cloud Platforms" as string, label: "Cloud Platforms" },
    { key: "Security & DevSecOps" as string, label: "Security & DevSecOps" },
    { key: "Databases" as string, label: "Databases" },
  ];
