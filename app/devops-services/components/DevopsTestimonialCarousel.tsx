...
const testimonials = [
  {
    id: 1,
    text: "Beelockchain helped us to streamline our CI/CD workflows & improve deployment speed significantly. Their DevOps consulting team ensured smooth infrastructure automation without disrupting our development process.",
    client: "James Anderson – Chief Technology Officer (CTO)",
    image: `${ASSET_URL}/images/testimonialcurosal2.webp`,
  },
  {
    id: 2,
    text: "The team’s expertise in cloud-native DevOps and infrastructure monitoring helped us reduce downtime and improve system reliability across our application environments.",
    client: "Michael Thompson – Founder & CEO",
    image: `${ASSET_URL}/images/testimonialcurosal3.webp`,
  },
  {
    id: 3,
    text: "With Beelockchain’s DevOps implementation services, we were able to automate deployment pipelines and maintain consistent software performance across distributed environments.",
    client: "Emma Wilson – Startup Co-Founder",
    image: `${ASSET_URL}/images/testimonialcurosal.webp`,
  },
];

const DevopsTestimonialCarousel = () => {
...
export default DevopsTestimonialCarousel;