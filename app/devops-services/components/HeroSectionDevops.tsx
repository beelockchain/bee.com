        ...
        >
          <div className="mx-auto w-full max-w-8xl px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="max-w-xl sm:max-w-2xl md:max-w-[400px] lg:max-w-2xl mx-auto md:mx-0">
              ...
              "
              >
                Beelockchain is a leading AI-powered DevOps development company
                that helps organizations automate software delivery and enhance
                deployment reliability with robust CI/CD pipelines. Our
                cloud-native DevOps expertise strengthens infrastructure
                security across modern application environments.
              </p>
