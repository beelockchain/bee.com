          ...
          >
            ...
            >
              <button className="w-full flex justify-between items-center gap-6 text-left cursor-pointer">
                <p className="text-black text-[11px] sm:text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px] font-manrope font-semibold">
                  {item.q}
                </p>
              ...
              <div className={`overflow-hidden transition-all duration-300 ${isOpen ? "max-h-50 mt-6" : "max-h-0"}`}>
                <p className="text-[11px] sm:text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px] text-black/80 leading-relaxed font-poppins">
                  {item.a}
                </p>
              </div>
            </div>
