  ...
  return createPortal(
    ...
    >
      ...
      <div className="bg-white rounded-xl shadow-xl border border-gray-200 px-4 py-3">
        <p className="text-sm font-bold text-black">{tip.user.name}</p>
    ...
    <>
      ...
      <div className="w-full bg-white mt-10">
        <div className="flex flex-col items-center w-full">
          ...
          <h2 className="mt-4  text-[19px] sm:text-[19px] md:text-[21px] lg:text-[28px] xl:text-[36px] text-black leading-tight font-bold">What We've Done</h2>
          <p className="text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px]  text-black leading-relaxed font-normal text-black text-center px-4">
