...
const leftFeatures = [
  {
    ...
    icon:"/assets/images/software-dev/custom-app-dev/app-ai.png",
    description:
  ...
  },
  {
    ...
    icon:"/assets/images/software-dev/custom-app-dev/app-iot.png",
    description:
  ...
  {
    title: "Blockchain",
    icon:"/assets/images/software-dev/custom-app-dev/app-blockchain.png",
    description:
...
const rightFeatures = [
  {
    ...
    icon:"/assets/images/software-dev/custom-app-dev/app-cloud.png",
    description:
  ...
  {
    title: "Generative AI",
    icon:"/assets/images/software-dev/custom-app-dev/app-generative.png",
    description:
  ...
  },
  {
    ...
    icon:"/assets/images/software-dev/custom-app-dev/app-ml.png",
    description:
...
const FeatureCard = ({
  ...
  >
    ...
    <div className="flex items-center gap-3">
      ...
      />
      <h3 className="text-gray-900 font-bold text-[18px] leading-snug">
        {title}
      </h3>
    </div>
  ...
  return (
    <section className="relative w-full py-10 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="text-center mb-8 sm:mb-10 lg:mb-14 max-w-6xl mx-auto flex flex-col justify-center items-center">
        <h2 className="text-[19px] sm:text-[19px] md:text-[21px] lg:text-[28px] xl:text-[36px]  text-black font-bold leading-tight font-bold leading-tight mb-3 sm:mb-4">
          Custom
          <span
        ...
        <p className="text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px]  text-black  font-semibold  w-full sm:w-2xl lg:w-3xl px-2">
