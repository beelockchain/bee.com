    ...
    <section className="w-full bg-white  px-4">
      ...
      <div className="text-center mb-10  mx-auto">
        <h2 className="text-[19px] sm:text-[19px] md:text-[21px] lg:text-[28px] xl:text-[36px] text-black leading-tight font-bold mb-3 max-w-7xl mx-auto">
          Mobile App<span data-text="Monetization Strategy" className="shine-text text-[#F5B800] relative mx-2">Monetization Strategy</span>
        </h2>
        <p className="text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px]  text-black leading-relaxed font-semibold  max-w-[670px] mx-auto">
