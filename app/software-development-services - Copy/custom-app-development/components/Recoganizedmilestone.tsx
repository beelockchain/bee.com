  ...
  return (
    <section className="w-full bg-white py-8 px-4">
      ...
      <div className="max-w-4xl mx-auto text-center mb-12">
        <h2 className="text-[19px] md:text-2xl lg:text-4xl font-bold text-gray-900 leading-tight mb-4">
          Awards &{" "}
        ...
        <p className="text-[#525252] text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px] font-semibold">
