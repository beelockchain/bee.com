...
export default function HeroSection({ 
  ...
  return (
    <div className='md:p-3 lg:p-3 xl:p-3  bg-white'>
            <section className="relative w-full min-h-[600px] md:min-h-[370px] lg:min-h-[450px] xl:min-h-[690px]  overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative z-10 h-full min-h-[600px] md:min-h-[370px] lg:min-h-[450px] xl:min-h-[650px] flex items-center">
