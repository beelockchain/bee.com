    ...
    <div className='md:p-3 lg:p-3 xl:p-3  bg-white id="top"'>
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          className="object-contain object-center rounded-2xl hidden sm:hidden md:block lg:block xl:block"
          priority
          quality={100}
        />
      </div>
        ...
        <div className=" container mx-auto px-3 md:px-10 lg:px-5 xl:px-5">
          <div className="md:pt-8 md:pb-8 lg:pt-8 lg:pb-8 xl:pt-8 xl:pb-8">
            ...
            <h1 className="mb-5 leading-[1.15] mt-3">
              <span className="block text-[20px] md:text-[25px] lg:text-[35px] xl:text-[48px] font-bold text-left md:text-left">
            ...
            <p className="text-[#525252] text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px] font-semibold leading-[1.65] xl:mt-5 mb-5 md:max-w-[325px] lg:max-w-[400px] xl:max-w-[730px] text-left md:text-left">
              Beelockchain is an AI chatbot development company delivering advanced AI chatbot development services that automate customer communication and enhance digital engagement. Our developers build scalable conversational AI solutions powered by NLP, machine learning, and GPT-based technologies.
            </p>
             <p className="text-[#525252] text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px] font-semibold leading-[1.65] xl:mt-10 mb-5 md:max-w-[325px] lg:max-w-[400px] xl:max-w-[720px] text-left md:text-left">
              Beelockchain is an AI chatbot development company helping businesses automate customer communication and improve engagement with intelligent conversational AI. Our AI chatbot developers build scalable chatbot solutions powered by NLP, machine learning, and GPT-based technologies for websites, mobile apps, and messaging platforms.
            </p>
