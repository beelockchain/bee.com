const Helpbusiness = () => {
  return (
        <>
        <section className="relative w-full bg-white overflow-hidden lg:h-screen xl:h-[80vh] flex items-center justify-center">
        
        <div className="relative w-full md:px-5 lg:px-15 xl:px-20">
            <div className="xl:mt-10">
                <h2 className="font-bold text-center md:text-center lg:text-center">
                <span className="block text-[18px] sm:text-[18px] md:text-[21px] lg:text-[28px] xl:text-[36px] text-[#1a1a1a]">
                    What Is
                ...
                <span data-text="Services" className="block shine-text relative text-[19px] sm:text-[19px] md:text-[21px] lg:text-[28px] xl:text-[36px] text-[#f5c518]">
                    ...
                    <span className="text-[#1a1a1a] text-[18px] sm:text-[18px] md:text-[21px] lg:text-[28px] xl:text-[36px]">
                    {" "}Help Businesses?
                    </span>
                </span>
                </h2>
    ...
    <div className="order-1 md:order-1 flex justify-center lg:justify-start xl:justify-center mb-15">
        <div className="relative w-70 sm:w-80 md:w-70 lg:w-100 xl:w-120 flex justify-center">
        <img
    ...
    {/* TEXT */}
    <div className="order-2 md:order-2 space-y-4 sm:space-y-2  xl:space-y-4 md:py-5 lg:py-3 xl:p-0">
        ...
        <div className="absolute -bottom-1 left-0 w-full h-28 pointer-events-none bg-gradient-to-b from-transparent to-[#ECECEC]" />
        </section>
