...
const awards = [
  {
    ...
    href: "https://www.goodfirms.co/company/beelockchain-digital-transformation-company",
    
  },
  {
    src: "/assets/images/beelock-reward2.png",
    alt: "Clutch Top Rated",
    href: "https://clutch.co/profile/beelockchain",
  },
  {
    ...
    <section className="w-full bg-white pb-5 px-4">
      ...
      <div className="max-w-4xl mx-auto text-center mt-10 mb-12">
        <h2 className="text-[18px] md:text-2xl lg:text-4xl font-bold text-gray-900 leading-tight mb-4">
          Awards &{" "}
          <span
            data-text="Recognition Milestones"
            className="shine-text relative text-[#f5c518]"
          >
        ...
        <p className="text-[#000000] text-[14px] md:text-[13px] xl:text-[16px] font-semibold">
          Our recognitions reflect our dedication to excellence and innovation
          in software and mobile app development services. We create solutions
          that provide long-term value for their business. This approach enables
          us to consistently exceed client expectations while maintaining
