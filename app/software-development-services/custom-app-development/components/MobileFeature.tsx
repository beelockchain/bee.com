...
const MobileFeature = () => {
  return (
    <div className="w-full bg-white py-8 px-4">
      ...
      {/* Subheading */}
      <p className="text-center text-black text-[14px] md:text-[12px] lg:text-[14px] xl:text-[16px]  text-black leading-relaxed font-normal  max-w-[840px] mx-auto mb-12 ">
        ...
        {features.map((feature, i) => (
          ...
          >
            ...
            <div className="flex-shrink-0 w-6 h-6 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center">
              <img
                src="/assets/images/software-dev/custom-app-dev/Logosvg.svg"
                alt="Feature Icon"
