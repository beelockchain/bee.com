    ...
    <div ref={sectionRef}>
      <div ref={gridRef} className="w-full bg-white py-0">
        <div className="max-w-[1400px] mx-auto px-6">
          {/* Heading */}
          <h2 className="text-center text-black text-[19px] sm:text-[20px] md:text-[20px] lg:text-[26px] xl:text-[34px] font-bold leading-tight mb-4">
            Core Technologies We Implemented
          </h2>

          {/* Subheading */}
          <p className="text-center text-black text-sm sm:text-sm md:text-lg xl:text-lg lg:text-lg font-normal mb-4">
